...
<head>
  ...
  <title>@yield('meta_title', 'Danik3255')</title>
  <meta name="description" content="@yield('meta_description', 'Danik3255')">
...
<body class="bg-light">
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark" aria-label="Main navigation">
    <div class="container-xl">
      <a href="/" class="navbar-brand fw-bold">DANIK3255</a>
  ...
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    <div class="container">
      ...
      <div class="col-md-4 d-flex align-items-center">
        ...
        <span class="mb-3 mb-md-0 text-muted">© {{ date('Y') }} Danik3255</span>
      </div>
