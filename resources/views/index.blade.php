  ...
  <div class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="img/track-on-road.jpg" class="d-block w-100 h-100" alt="...">
        <div class="carousel-caption d-none-d-md-block">
          <h1 class="d-none d-md-block fw-normal text-info shadow -shadow-1">Отслеживание по трек коду</h1>
